 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: menber_menu.ctp 4433 2009-09-22 10:08:09Z huangbo $
*****************************************************************************/
?>
<div class="category_box catmenus">
<h3 class="font_14"><span class="l"></span><span class="r"></span><?php echo $SCLanguages['my_account']?></h3>
<div class="box">
<ul class="left_menus">
	...
	<li class="Nav"><?php echo $html->link($SCLanguages['my_order'],'/orders/',array('class'=>'svcartmenuitemlabel'))?></li>
	...
	<li class="Nav"><?php echo $html->link($SCLanguages['my_comments'],'/comments/',array('class'=>'svcartmenuitemlabel'));?></li>
	<?php if(isset($can_affiliate)){?>
	<li class="Nav"><?php echo $html->link($SCLanguages['my_recommend'],'/recommends/',array('class'=>'svcartmenuitemlabel'));?></li>
	<?php }?>
