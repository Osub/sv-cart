	function ajax_init(){
		    ...
		    this.oACDS = new YAHOO.widget.DS_XHR(server_host+cart_webroot+"products/search_autocomplete/", ["ResultSet.Result","name"]);
	...
	function to_product(id){
		window.location.href=server_host+cart_webroot+"products/"+id;
	}
