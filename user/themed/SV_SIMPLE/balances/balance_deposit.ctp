 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: balance_deposit.ctp 1160 2009-04-30 11:02:24Z shenyunfeng $
*****************************************************************************/
ob_start();
?>
<div id="loginout">
	...
	<div class="login-alettr"><?php echo $html->image('icon-10.gif');?>
	<?php echo $result['msg']?>
	...
	<?php }?>
		...
		<p class="btns">
			<?php echo $html->link($html->image('loginout-btn_right.gif').$SCLanguages['confirm'],"javascript:window.location.reload();","",false,false);?>
		</p>
	</div>
