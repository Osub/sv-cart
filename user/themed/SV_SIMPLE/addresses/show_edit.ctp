 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: show_edit.ctp 1363 2009-05-14 06:18:55Z shenyunfeng $
*****************************************************************************/
ob_start();
if ($result['type'] == 0){?>
...
<ul>
 ...
 <li>
  ...
  <li>
    ...
    <dt style="white-space:nowrap;"><input name="data[UserAddress][zipcode]" id="UserAddressZipcode" size="27" maxLength="18" onKeyUp="is_int(this);" value="<?php echo $result['address']['UserAddress']['zipcode']?>" />&nbsp;<font color="red" id="zipcode_msg">*</font></dt></li>
    <li>
