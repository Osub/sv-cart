 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: login_ajax_successful.ctp 1278 2009-05-10 13:07:28Z huangbo $
*****************************************************************************/
...
<div id="loginout">
	...
	<b><?php echo $SCLanguages['welcome'];?>，<?php echo $user_info['User']['name']; ?>！</b> <br /></p>
		<p class="btns">
			<?php echo $html->link($html->image('loginout-btn_right.gif').$SCLanguages['continue'],"javascript:window.location.reload();","",false,false);?>
