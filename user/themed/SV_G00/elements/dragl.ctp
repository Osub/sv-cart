...
<!--Login-->
<div id="User_Login" class="svcart-overlay"><div class="hd title"><b><?=$SCLanguages['user'].$SCLanguages['login'];?></b></div>
<div class="keywords"><dl><dt><?php echo $SCLanguages['username'];?></dt><dd><input type="text" name="data[User][name]" id="UserName" class="enter text_input" /></dd></dl>
	...
	<?=$html->link("<font face='宋体'>>></font>".$SCLanguages['forget_password'],"/forget_password/",array(),false,false);?>
    </dd>
    </dl>
