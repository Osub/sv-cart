 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: header.ctp 1116 2009-04-28 11:04:43Z huangbo $
*****************************************************************************/
?>
...
<div class="tools">
	...
	<?php echo $SCLanguages['welcome'];?><b>&nbsp;<?=$html->link($_SESSION['User']['User']['name'],"/../user/",array("title"=>$SCLanguages['user_center'],"class"=>"name color_f9"));?></b><font>|</font><?=$html->link($SCLanguages['log_out'],"javascript:logout();",array("class"=>"color_4"));?><font>|</font><? }else{ ?><a class="cursor color_4" id="login"><?=$SCLanguages['member'].$SCLanguages['login'];?></a><font>|</font><?php if($SVConfigs['enable_registration_closed'] == 0){?>
		<?=$html->link($SCLanguages['member'].$SCLanguages['register'],"/../user/register/",array("class"=>"color_4"),"",false,false);?>
		<font>|</font>
