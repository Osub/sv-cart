...
<div class="tools">
	...
	<?php echo $SCLanguages['welcome'];?><b>&nbsp;<?=$html->link($_SESSION['User']['User']['name'],"/../user/",array("title"=>$SCLanguages['user_center'],"class"=>"name color_f9"));?></b><font>|</font><?=$html->link($SCLanguages['log_out'],"javascript:logout();",array("class"=>"color_4"));?><font>|</font><? }else{ ?><a class="cursor color_4" id="login"><?=$SCLanguages['login'];?></a><font>|</font><?php if($SVConfigs['enable_registration_closed'] == 0){?>
