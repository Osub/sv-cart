 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: change_remark.ctp 3225 2009-07-22 10:59:01Z huangbo $
*****************************************************************************/
ob_start();?>
<?php if($result['type'] == 0 ){?>
<h5><?php echo $SCLanguages['order'].$SCLanguages['remark'];?>:</h5>
<?php echo $this->element('checkout_remark', array('cache'=>'+24 hour'));?>
<?php }else{?>
	<div id="loginout">
	<h1><b style="font-size:14px"><?php echo $SCLanguages['order'].$SCLanguages['remark'];?></b></h1>
