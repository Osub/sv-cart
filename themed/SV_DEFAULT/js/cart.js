...
//将购物车页的促销商品添加到购物车--begin
	function buy_on_cart_page(type,id){
		...
		var postData ="id="+id+"&quantity="+1+"&page=cart&type="+type+"&is_ajax=1";
...
//购买数量的改变-end
	...
	//	set_wait(please_wait_consignee_information);
	//	YAHOO.example.container.wait.show();
		var i=0;
		var Region="";
		while(true){
...
//		document.getElementById('edit_address_zipcode').innerHTML = "*";
 	...
 	//	var tel_2 =document.getElementById('tel_2').value;
		...
		document.getElementById('edit_address_regions').innerHTML = choose_area;
 		...
 		document.getElementById('checkout_address').innerHTML = "";
		document.getElementById('address_loading').style.display = "";
 ...
 //		var tel_1 =document.getElementById('add_tel_1').value;
	...
	function confirm_insure_fee(shipping_id,insure_fee,type){
		 document.getElementById('insure_fee_loading').style.display ="";
		  set_wait(wait_message);
		  YAHOO.example.container.wait.show();
			//type == 1 确定 == 2 取消
		  var sUrl = webroot_dir+"carts/confirm_insure_fee/";
	      var postData ="shipping_id="+shipping_id+"&insure_fee="+insure_fee+"&type="+type;
		  var request = YAHOO.util.Connect.asyncRequest('POST', sUrl, confirm_insure_fee_callback,postData);
	}
	
	var confirm_insure_fee_Success = function(o){
		try{
			var result = YAHOO.lang.JSON.parse(o.responseText);
		}catch (e){   
			//alert(o.responseText);
		...
		YAHOO.example.container.wait.hide();
		document.getElementById('checkout_total').innerHTML = result.checkout_total;
		document.getElementById('shipping_insure_fee').innerHTML = result.checkout_shipping;
	}
	
	var confirm_insure_fee_callback ={
		success:confirm_insure_fee_Success,
		failure:failure_todo,
		timeout : 30000,
		argument: {}
	};	
	...
	//	set_wait(please_wait_shipping_method);
	//	YAHOO.example.container.wait.show();
		document.getElementById('checkout_shipping').style.display = "none";	
		document.getElementById('shipping_loading').style.display = "";		
	...
	var confirm_shipping_Success = function(o){
		...
		document.getElementById('checkout_shipping').style.display = "";	
		document.getElementById('shipping_loading').style.display = "none";
	//	YAHOO.example.container.wait.hide();
		if(result.type == "0"){
...
//		set_wait(please_wait_payment);
//		YAHOO.example.container.wait.show();
		document.getElementById('payment').style.display = "none";	
		document.getElementById('payment_loading').style.display = "";			
...
function confirm_promotion(type,id,type_ext,title,meta_description){
    ...
    var confirm_promotion_Success = function(o){
      ...
      //  alert(result.type);
        YAHOO.example.container.wait.hide();
        document.getElementById('promotions').style.display = "";
        document.getElementById('promotion_loading').style.display = "none";
        if(result.type == "0" || result.type == "1"){
   ...
   //     YAHOO.example.container.wait.hide();
    ...
    function usepoint(max,order){
	   ...
	   if(point == ""){
		...
		set_wait(please_wait_point);
		YAHOO.example.container.wait.show();
		document.getElementById('point').style.display = "none";	
		document.getElementById('point_loading').style.display = "";			
    ...
    var usepoint_Success = function(o){
		...
		document.getElementById('point_loading').style.display = "none";       
    ...
    function checkout_order(){
    	set_wait(orders_submitting_please_wait);
		YAHOO.example.container.wait.show();
...
/*        try{
	...
	//	set_wait(please_wait_coupon);
	//	YAHOO.example.container.wait.show();
		document.getElementById('coupon').style.display = "none";	
		document.getElementById('coupon_loading').style.display = "";			
    ...
    var usecoupon_Success = function(o){
     ...
     //   YAHOO.example.container.wait.hide();
		...
		document.getElementById('coupon_loading').style.display = "none";        
        if(result.type == "0" ){
