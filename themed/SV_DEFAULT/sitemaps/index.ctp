...
<?php 
 ...
 ?>
<div class="sorts">
<h2><?php echo $html->image(isset($img_style_url)?$img_style_url."/"."right_icon02.gif":"right_icon02.gif",array("alt"=>'right_icon02.gif'))?><span><?php echo $html->link("{$v['CategoryI18n']['name']}","/categories/{$v['Category']['id']}",array(),false,false);?></span></h2>
<p>
<?php 
	 $first=1; 
