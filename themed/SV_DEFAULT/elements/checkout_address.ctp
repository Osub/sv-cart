 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: checkout_address.ctp 3184 2009-07-22 06:09:42Z huangbo $
*****************************************************************************/
?>
<h5>
<a href="javascript:show_address_edit('<?php echo $address['UserAddress']['id']?>')" class="amember"><span ><?php echo $SCLanguages['mmodify']?></span></a>
...
<tr>
	...
	<td class="lan-info" width="85%"><?php echo $address['UserAddress']['name'];?></td>
</tr>
<tr>
	<td class="lan-name first"><?php echo $SCLanguages['consignee'].$SCLanguages['name'];?>:</td>
	<td class="lan-info"><?php echo $address['UserAddress']['consignee'];?></td>

</tr>
<tr>
	<td class="lan-name first"><?php echo $SCLanguages['mobile'];?>:</td>
	<td class="lan-info"><?php echo $address['UserAddress']['mobile'];?></td>
</tr>
<tr>
	<td class="lan-name first"><?php echo $SCLanguages['telephone'];?>:</td>
	<td class="lan-info"><?php echo $address['UserAddress']['telephone'];?></td>
</tr>
<tr>
	<td class="lan-name first"><?php echo $SCLanguages['email'];?>:</td>
	<td class="lan-info"><?php echo $address['UserAddress']['email'];?></td>
</tr>
</table>
<?php }?>