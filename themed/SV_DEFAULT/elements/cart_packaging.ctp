 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: cart_packaging.ctp 2525 2009-07-02 05:42:37Z shenyunfeng $
*****************************************************************************/
?>
...
<div class="Number_select">
 <span class="top"><?php echo $html->link($html->image(isset($img_style_url)?$img_style_url."/"."ico_top.gif":"ico_top.gif",array()),"javascript:quantity_change('+',".$i.")","",false,false);?></span>
...
<span class="bottom"><?php echo $html->link($html->image(isset($img_style_url)?$img_style_url."/"."ico_bottom.gif":"ico_bottom.gif",array()),"javascript:quantity_change('-',".$i.")","",false,false);?></span>
</div>
<div class="Sums">
<span class="Number"><?php echo $p['subtotal'];?></span>
</div>
<div class="btn_list"> <span class=del><?php echo $html->link(__($SCLanguages['delete'],array()),"javascript:remove_product(".$i.")","",false,false);?></span><span><?php echo $html->link(__($SCLanguages['favorite'],array()),"javascript:new_favorite(".$i.",'p')","",false,false);?></span><span><?php echo $html->link(__($SCLanguages['detail'],array()),"/products/index/".$i."/","",false,false);?></span></div>
</div>
<?php }?>
</div>
<div id="balance">
