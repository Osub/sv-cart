 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: advancedsearch.ctp 3949 2009-08-31 07:34:05Z huangbo $
*****************************************************************************/
?>
...
<b><?php echo $SCLanguages['advanced_search'];?></b></h1>
	...
	<?php echo $form->create('Product', array('action' => 'Search','id'=>'a_s'));?> 
	<div id="ysearch" class="green_3">
	<dl>
	<dd><?php echo $SCLanguages['keywords'];?>：</dd>
	<dt><input id="ysearchinput_search" class="text_input"  type="text" name="keywords" style="width:176px;" value="<?php if(isset($keywords) && $not_show == 0){echo $keywords;}?>"/></dt>
	...
	<option value="0" <?php if(isset($category_id) && $category_id == 0){?>selected='selected'<?}?>><?php echo $SCLanguages['please_choose'];?></option>
...
<?php if(isset($brands) && sizeof($brands)>0){?>	<dl>
	...
	<option value="0" <?php if(isset($brand_id) && $brand_id == 0){?>selected='selected'<?}?>><?php echo $SCLanguages['please_choose'];?></option>
