 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: remove.ctp 2703 2009-07-08 11:54:52Z huangbo $
*****************************************************************************/
ob_start();?>
...
<div class="shops">
<ul>
<li class="pic"><?php echo $html->image($product_info['Packaging']['img01'],array("alt"=>$product_info['PackagingI18n']['name'],"width"=>75,"height"=>75));?></li>
<li>
...
<div class="shops">
<ul>
<li class="pic"><?php echo $html->image($product_info['Card']['img01'],array("alt"=>$product_info['CardI18n']['name'],"width"=>75,"height"=>75));?></li>
<li>
