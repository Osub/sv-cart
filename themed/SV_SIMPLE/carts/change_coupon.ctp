 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: change_coupon.ctp 2703 2009-07-08 11:54:52Z huangbo $
*****************************************************************************/
ob_start();?>
...
</p><?php echo $this->element('checkout_coupon', array('cache'=>'+0 hour'));?>
<?php }else{?>
	<div id="loginout">
...
<?php }?>
<?php 
$result['checkout_coupon'] = ob_get_contents();
ob_end_clean();
?>
<?php ob_start();?>
