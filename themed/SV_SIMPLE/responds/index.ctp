...
<div id="globalBalance">
	...
	<p class="succeed">
	<?php if(isset($fail)){?>
	<?php echo $html->image("warning_img.gif",array("align"=>"middle","alt"=>$msg))?>
	<?php }else{?>
	<?php echo $html->image("icon-10.gif",array("align"=>"middle","alt"=>$msg))?>
	<?php }?>
	...
	<?php }?>
    <br />
    <p><?php echo $html->image("succeed02_img.gif")?></p>
