 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: category_A.ctp 2703 2009-07-08 11:54:52Z huangbo $
*****************************************************************************/
?>
<!--文章分类显示开始-->
...
<?php }?>
<?php if(isset($first_v['SubCategory']) && sizeof($first_v['SubCategory'])>0){?>
<div class="svcartmenu"><?php echo $html->image('LeftsubNav_top.gif',array("alt"=>"", "align"=>"left"))?><div class="bd Sub_bd"><ul class="secend_muen">
...
<?php }?></ul></div></div>
<?php }?></li>
<?php }?></ul></div><?php echo $html->image('LeftsubNav_bottom.gif',array("alt"=>"","align"=>"top"))?></div>
<?php }?></li>
<?php }?></ul></div></div></div></div><p><?php echo $html->image('category_ulbt.gif',array("alt"=>""))?></p></div>
<?php }?>
