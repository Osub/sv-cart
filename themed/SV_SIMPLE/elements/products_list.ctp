 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: products_list.ctp 2758 2009-07-10 08:46:03Z wuchao $
*****************************************************************************/
?>
<div id="Item_ListBox">
<p class="View_item">
...
<?php }else{?>
	...
	<?php if(isset($SVConfigs['use_ajax']) && $SVConfigs['use_ajax'] == 0){?>
		<?php echo $form->create('carts',array('action'=>'buy_now','name'=>'buy_nowproduct'.$v['Product']['id'],'type'=>'POST'));?>
			...
			<?php echo $html->link("<span>".$SCLanguages['buy']."</span>","javascript:buy_now_no_ajax({$v['Product']['id']},1,'product')",array('class'=>'addtocart'),false,false)?>
		<?php echo $form->end();?>
	<?php }else{?>		
