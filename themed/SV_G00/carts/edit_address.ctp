 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: edit_address.ctp 1093 2009-04-28 04:02:04Z huangbo $
*****************************************************************************/
ob_start();?>
<?if ($result['type'] == 0){?>
	<?if(empty($result['all_virtual'])){?>
<div class="Balance_alltitle" style="margin-bottom:0;"><h1 class="headers"><span class="l"></span><span class="r"></span><b><?=$SCLanguages['mmodify']?></b></h1></div>
<div id="Balance_info" style='background:#fff;margin-top:0;width:892px;'>
<p class="address border_bottom">
<span class="l"></span><span class="r"></span><?=$SCLanguages['mmodify'].$SCLanguages['consignee'].$SCLanguages['information'];?>:
</p>
...
<a href="javascript:edit_address_act();" class="float_r"><span><?=$SCLanguages['mmodify']?></span></a></td>
<td colspan="2" style="padding-left:4px;">
<a href="javascript:close_message_width();" class="float_l"><span><?=$SCLanguages['cancel']?></span></a></td>
</tr>
</table>
<p class="edittitle address">
<span class="l"></span><span class="r"></span><?=$SCLanguages['add'];?><?=$SCLanguages['consignee'];?><?=$SCLanguages['information'];?>:
</p>
<table cellpadding="0" cellspacing="0" class="address_table" border=0 align="center">
<tr>
<td class="lan-name">&nbsp;<?=$SCLanguages['address'];?><?=$SCLanguages['label'];?>:</td>
...
<a href="javascript:checkout_new_address();" class="float_r"><span><?=$SCLanguages['add']?></span></a>
</td>
<td colspan="2" align="left" style="padding-left:4px;">
<a href="javascript:close_message_width();" class="float_l"><span><?=$SCLanguages['cancel']?></span></a>
</td>
</tr>
</table>
<br />
...
<h1 class="headers"><span class="l"></span><span class="r"></span><b><?=$SCLanguages['mmodify']?></b></h1>
</div>
...
<td colspan="1">
<a href="javascript:edit_virtual_address_act();" class="float_l" style="margin-right:4px;"><span><?=$SCLanguages['mmodify']?></span></a>
<a href="javascript:close_message_width();" class="float_l"><span><?=$SCLanguages['cancel']?></span></a></td>
</tr>
</table>
...
<p class="edittitle">
<strong><?=$SCLanguages['add'];?><?=$SCLanguages['consignee'];?><?=$SCLanguages['information'];?>:</strong>
</p>
...
<a href="javascript:checkout_new_virtual_address();" class="float_l" style="margin-right:4px;"><span><?=$SCLanguages['add']?></span></a>
<a href="javascript:close_message_width();" class="float_l"><span><?=$SCLanguages['cancel']?></span></a>
</td>
</tr>
</table>
