...
<div id="Flash"><?=$flash->renderSwf('img/bcastr4.swf?xml='.$this->webroot.'flashes/index/B/'.$id,$flashes['Flash']['width'],$flashes['Flash']['height'],false,array('params' => array('movie'=>$this->webroot.'img/bcastr4.swf?xml='.$this->webroot.'flashes/index/B/'.$id,'wmode'=>'Opaque')));?></div>
<?}?>
