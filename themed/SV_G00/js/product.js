...
function dropImg(ImgId){
		...
		var sUrl = webroot_dir+"sv-admin/products/drop_img/"+ImgId;
...
function searchArticles(){
		...
		var sUrl = webroot_dir+"sv-admin/articles/searcharticles/"+Article_keywords+"/"+Article_cat;
...
function searchProducts(){
		...
		var sUrl = webroot_dir+"sv-admin/products/searchproducts/"+keywords+"/"+catId+"/"+brandId;
