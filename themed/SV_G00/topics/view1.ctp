 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: view.ctp 887 2009-04-22 10:46:25Z shenyunfeng $
*****************************************************************************/
?>
<style type="text/css">
<!--
<?if(isset($topic['Topic']['css']) && $topic['Topic']['css'] != ""){?>
<?=$topic['Topic']['css']?>
<?}?>
-->
</style>
<?php echo $this->element('ur_here', array('cache'=>'+0 hour'));?>
	<div id="Products_box">
    	<h1><b><? echo $topic['TopicI18n']['title']; ?></b></h1>
        <div id="Edit_box">
  <div id="article_info">
  ...
  <div id="user_msg">
  	<p class="article_time">
  	  <span class="title">&nbsp;<? echo $topic['Topic']['start_time']." - ".$topic['Topic']['end_time']; ?></span></p><br />
    <p class="article">
    	<span>
    		<? echo $topic['TopicI18n']['intro']; ?>
    	</span>
    </p>
  </div>
