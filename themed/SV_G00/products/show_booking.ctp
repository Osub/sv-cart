 ...
 *===========================================================================
 * $开发: 上海实玮$
 * $Id: show_booking.ctp 1028 2009-04-24 12:23:26Z huangbo $
*****************************************************************************/
ob_start();?>	
<?if($result['type'] == 0){?>
...
<div id="Edit_box" style="width:658px;background:#fff;margin-top:0;">
	<div id="Edit_info" style="width:658px;">
		<div id="comments">
			...
			<dl>
				<dd><?=$SCLanguages['products'];?></dd>
				<dt><?=$product_info['ProductI18n']['name']?></dt>
			</dl>
			<dl>
				<dd><?php echo $SCLanguages['sku'];?></dd>
				<dt><?=$product_info['Product']['code']?></dt>
			</dl>			
			<dl>
				<dd id="user_name" ><?=$SCLanguages['quantity'];?></dd>
			...
			<dl>
				<dd id="user_name" ><?=$SCLanguages['telephone'];?></dd>
			...
			<input type='hidden' name='data[bookings][product_id]' id="product_id" value="<?echo $result['id']?>" >
			<input type="submit" value="<?=$SCLanguages['submit']?>" style="cursor:pointer" class="submit_comment" id="submit_comment" onclick="javascript:add_booking();"/>
