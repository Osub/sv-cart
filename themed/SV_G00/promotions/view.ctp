...
<?php echo $this->element('ur_here', array('cache'=>'+0 hour'));?>
  ...
  <div id="user_msg">
  	<p class="article_time">
  	  <span class="title">&nbsp;<? echo $promotion['Promotion']['start_time']." - ".$promotion['Promotion']['end_time']; ?></span></p><br />
    <p class="article">
    	<span>
    		<? echo $promotion['PromotionI18n']['meta_description']; ?>
    	</span>
    </p>
  </div>
...
<div id="Correlation" class="article_items">
        	<h1 class="title_nobg"><span><?=$html->image('icon_08.gif')?></span><?=$SCLanguages['correlative_products'];?></h1>
