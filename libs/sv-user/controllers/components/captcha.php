...
class CaptchaComponent extends Object {
    ...
    var $_image_width = 66; //the width of the captcha image
    ...
    var $_text_minimum_distance = 13; //minimum distance for spacing between letters in pixels
    var $_text_x_start = 5; //the x-position on the image where letter drawing will begin
