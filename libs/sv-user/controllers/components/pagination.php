 ...
 * @return array 
 */ 
    function init($criteria=NULL,$parameters=Array(),$options=Array(),$total,$rownum,$sortClass) 
    { 
        uses('sanitize'); 
        $show=$rownum;
        //echo $show;
        $this->total=$total;
        $this->sortByClass=$sortClass;
        ...
        //pr($this->_initSort());
        $this->_initPaging($parameters,$rownum); 
        $this->_initURL(); 
 ...
 * @param unknown 
 */ 
    function _initPaging($parameters,$rownum) 
    {   
