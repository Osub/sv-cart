 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: payment.php 3795 2009-08-19 11:25:53Z huangbo $
*****************************************************************************/
class Payment extends AppModel
{
    ...
    function set_locale($locale){
 	...
 	function availables(){
	    ...
	    'fields'=>array('Payment.id','Payment.code','PaymentI18n.status','Payment.fee','Payment.config','Payment.is_cod','Payment.is_online','Payment.supply_use_flag','Payment.order_use_flag'
