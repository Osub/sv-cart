...
CREATE TABLE IF NOT EXISTS `svcart_advertisements` (
  ...
  `is_showimg` char(1) collate utf8_unicode_ci NOT NULL default '0' COMMENT '是否显示图片',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='广告';
...
CREATE TABLE IF NOT EXISTS `svcart_advertisement_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '广告名称',
  `description` text collate utf8_unicode_ci COMMENT '广告描述',
  `url` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '广告地址',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='广告多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_articles` (
  ...
  `author_email` varchar(60) collate utf8_unicode_ci NOT NULL default '' COMMENT '作者E-mail',
  ...
  KEY `store_id` (`store_id`),
  KEY `type` (`type`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='文章详细表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='文章分类关联';
...
CREATE TABLE IF NOT EXISTS `svcart_article_i18ns` (
  ...
  `locale` varchar(10) collate utf8_unicode_ci NOT NULL default '' COMMENT '语言编码',
  `article_id` int(11) NOT NULL default '0' COMMENT '文章编号',
  `title` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '分类名称',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='文章详细多语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_booking_products` (
  ...
  `is_dispose` char(1) collate utf8_unicode_ci NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `svcart_brands` (
  ...
  `status` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '状态[0:无效;1:有效;]',
  `url` varchar(100) character set utf8 NOT NULL default '' COMMENT '品牌网址',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='品牌';
...
CREATE TABLE IF NOT EXISTS `svcart_brand_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '品牌名称',
  `description` text collate utf8_unicode_ci COMMENT '品牌描述',
  `meta_keywords` tinytext collate utf8_unicode_ci COMMENT 'SEO品牌关键字',
  `meta_description` tinytext collate utf8_unicode_ci COMMENT 'SEO品牌描述',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='品牌多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_cards` (
  ...
  PRIMARY KEY  (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='贺卡';
...
CREATE TABLE IF NOT EXISTS `svcart_card_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '贺卡名称',
  `description` text collate utf8_unicode_ci COMMENT '贺卡描述',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  ...
  FULLTEXT KEY `name` (`name`),
  FULLTEXT KEY `description` (`description`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='贺卡多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_carts` (
  `id` int(10) unsigned NOT NULL auto_increment COMMENT 'ID',
  `session_id` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '进程编号',
  `user_id` int(11) NOT NULL default '0' COMMENT '用户编号',
  `store_id` int(11) NOT NULL default '0' COMMENT '商店编号',
  `product_id` int(11) NOT NULL default '0' COMMENT '商品编号',
  `product_code` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '商品代码',
  `product_name` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '商品名称',
  `product_price` float(12,2) NOT NULL default '0.00' COMMENT '商品价格',
  `product_quantity` smallint(6) NOT NULL default '0' COMMENT '购买商品数量',
  `product_attrbute` text collate utf8_unicode_ci COMMENT '商品属性',
  `type` char(1) collate utf8_unicode_ci default NULL,
  `extension_code` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT 'virtual_card：虚拟商品',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='分类';
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='分类多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_comments` (
  ...
  `type` char(1) collate utf8_unicode_ci NOT NULL default '' COMMENT '评论类型[商品，分类，品牌，文章，商店]',
  `type_id` int(11) NOT NULL default '0' COMMENT '类型编号',
  `email` varchar(60) collate utf8_unicode_ci NOT NULL default '',
  `name` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '姓名',
  ...
  `rank` char(1) collate utf8_unicode_ci NOT NULL default '0' COMMENT '评论等级',
  ...
  FULLTEXT KEY `title` (`title`),
  FULLTEXT KEY `content` (`content`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户评论表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统参数值多语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_coupon_type_i18ns` (
  ...
  `locale` varchar(10) collate utf8_unicode_ci NOT NULL default '' COMMENT '语言编码',
  `coupon_type_id` int(11) NOT NULL default '0' COMMENT '优惠券类型编号',
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '优惠券名称',
  ...
  KEY `locale` (`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='优惠券多语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_departments` (
  ...
  PRIMARY KEY  (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='部门';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='部门多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_flashes` (
  ...
  `type` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '类型[H:首页;PC:分类;B:品牌;AC:文章分类]',
  `type_id` int(11) NOT NULL default '0',
  `roundcorner` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `autoplaytime` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `isheightquality` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `blendmode` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `transduration` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `windowopen` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `btnsetmargin` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `btndistance` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `titlebgcolor` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `titletextcolor` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `titlebgalpha` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `titlemoveduration` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `btnalpha` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `btntextcolor` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `btndefaultcolor` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `btnhovercolor` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `btnfocuscolor` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `changimagemode` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `isshowbtn` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `isshowtitle` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `scalemode` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `transform` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `isshowabout` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `titlefont` varchar(20) collate utf8_unicode_ci NOT NULL default '',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='FLASH图片表';
...
CREATE TABLE IF NOT EXISTS `svcart_languages` (
  ...
  KEY `front` (`front`),
  KEY `backend` (`backend`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_link_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '友情链接名称',
  `description` text collate utf8_unicode_ci COMMENT '友情链接描述',
  `url` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '友情链接地址',
  ...
  FULLTEXT KEY `name` (`name`),
  FULLTEXT KEY `description` (`description`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='友情链接多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_mail_templates` (
  ...
  `code` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '编号',
  `status` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '状态[0:无效;1:有效;]',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='邮件模板';
...
CREATE TABLE IF NOT EXISTS `svcart_mail_template_i18ns` (
  ...
  `title` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '邮件模板名称',
  `text_body` text collate utf8_unicode_ci COMMENT '邮件模板text模板',
  `html_body` text collate utf8_unicode_ci COMMENT '邮件模板HTML模板',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `locale` (`locale`,`mail_template_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='邮件模板多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_navigations` (
  ...
  `type` char(1) collate utf8_unicode_ci NOT NULL default '' COMMENT '导航类型[H;T;M;B...]',
  `orderby` tinyint(4) NOT NULL default '10' COMMENT '排序',
  `status` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '状态[0:无效;1:有效;]',
  `icon` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '缩略图',
  `target` enum('_self','_blank') collate utf8_unicode_ci NOT NULL default '_self' COMMENT '打开位置',
  `controller` enum('pages','categories','brands','products','articles','cars') collate utf8_unicode_ci NOT NULL default 'pages' COMMENT '系统内容',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  KEY `type` (`type`,`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='导航栏';
...
CREATE TABLE IF NOT EXISTS `svcart_navigation_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '导航栏名称',
  `url` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT 'URL链接',
  `description` text collate utf8_unicode_ci COMMENT '描述',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  ...
  KEY `locale` (`locale`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='导航栏多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_newsletter_lists` (
  ...
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='邮件订阅表';
...
CREATE TABLE IF NOT EXISTS `svcart_operators` (
  ...
  `password` varchar(64) collate utf8_unicode_ci NOT NULL default '' COMMENT '管理员密码',
  `email` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '管理员邮件',
  `mobile` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '管理员手机',
  ...
  `actions` text collate utf8_unicode_ci COMMENT '功能权限',
  `default_lang` varchar(10) collate utf8_unicode_ci NOT NULL default 'zh_cn' COMMENT '管理员默认语言',
  `desktop` text collate utf8_unicode_ci COMMENT '桌面设置',
...
CREATE TABLE IF NOT EXISTS `svcart_operator_actions` (
  ...
  `code` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '代码',
  ...
  KEY `level` (`level`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='管理员权限表';
...
CREATE TABLE IF NOT EXISTS `svcart_operator_action_i18ns` (
  ...
  `values` varchar(500) NOT NULL default '' COMMENT '值',
  ...
  KEY `locale` (`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='管理员权限语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_operator_logs` (
  ...
  `ipaddress` varchar(30) collate utf8_unicode_ci NOT NULL default '' COMMENT 'IP地址',
  `action_url` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '访问地址',
  `info` text collate utf8_unicode_ci COMMENT '备注',
  `type` char(1) collate utf8_unicode_ci NOT NULL default '' COMMENT '类型',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
...
CREATE TABLE IF NOT EXISTS `svcart_operator_menus` (
  ...
  `operator_action_code` varchar(250) collate utf8_unicode_ci NOT NULL default '' COMMENT '权限代码',
  `type` varchar(1) collate utf8_unicode_ci NOT NULL default '' COMMENT '类型',
  `link` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '连接地址',
  `status` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '状态[0:无效;1:有效;]',
  `orderby` tinyint(4) NOT NULL default '50' COMMENT '排序',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='菜单多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_operator_roles` (
  ...
  PRIMARY KEY  (`id`),
  KEY `store_id` (`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='管理员角色';
...
CREATE TABLE IF NOT EXISTS `svcart_operator_role_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '角色名称',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  KEY `locale` (`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='管理员角色多语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_packagings` (
  ...
  PRIMARY KEY  (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='包装';
...
CREATE TABLE IF NOT EXISTS `svcart_packaging_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '包装名称',
  `description` text collate utf8_unicode_ci COMMENT '包装描述',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  ...
  FULLTEXT KEY `name` (`name`),
  FULLTEXT KEY `description` (`description`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='包装多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_payment_i18ns` (
  ...
  KEY `status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='支付方式多语言';
...
CREATE TABLE IF NOT EXISTS `svcart_products` (
  ...
  `code` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '分类编号',
  `product_name_style` varchar(60) collate utf8_unicode_ci NOT NULL default '+' COMMENT '商品名称样式',
  `img_thumb` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '缩略图',
  `img_detail` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '详细图',
  ...
  KEY `forsale` (`forsale`),
  KEY `category_id` (`category_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品';
...
CREATE TABLE IF NOT EXISTS `svcart_products_categories` (
  ...
  KEY `category_id` (`category_id`),
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品分类关联';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品文章关联';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品相册';
...
CREATE TABLE IF NOT EXISTS `svcart_product_gallery_i18ns` (
  `id` int(11) NOT NULL auto_increment COMMENT '商品相册多语言编号',
  `locale` varchar(10) collate utf8_unicode_ci NOT NULL default '' COMMENT '语言编码',
  `product_gallery_id` int(11) NOT NULL default '0' COMMENT '商品相册编号',
  `description` text collate utf8_unicode_ci COMMENT '商品相册描述',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品相册多语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_product_i18ns` (
  ...
  `locale` varchar(10) collate utf8_unicode_ci NOT NULL default '' COMMENT '语言编码',
  `product_id` int(11) NOT NULL default '0' COMMENT '商品编号',
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '商品名称',
  `description` text collate utf8_unicode_ci COMMENT '详细描述',
  `market_price` float(10,2) NOT NULL default '0.00' COMMENT '市场价',
  `shop_price` float(10,2) NOT NULL default '0.00' COMMENT '本店价',
  `meta_keywords` tinytext collate utf8_unicode_ci COMMENT 'SEO关键字',
  `meta_description` tinytext collate utf8_unicode_ci COMMENT 'SEO描述',
  `api_site_url` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '商品网站网址',
  `api_cart_url` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '购物车快捷网址',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  ...
  FULLTEXT KEY `name` (`name`),
  FULLTEXT KEY `description` (`description`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_product_relations` (
  ...
  PRIMARY KEY  (`id`),
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品关联表';
...
CREATE TABLE IF NOT EXISTS `svcart_product_types` (
  `id` int(11) NOT NULL auto_increment COMMENT '分类编号',
  `group_code` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '分组',
  `status` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '0:无效;1:有效;2:删除',
  `orderby` tinyint(4) NOT NULL default '50' COMMENT '排序',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  KEY `cat_id` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品类型';
...
CREATE TABLE IF NOT EXISTS `svcart_product_type_attributes` (
  ...
  `attr_value` text character set utf8 COMMENT '属性值',
  `status` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '0:无效;1:有效;2:删除',
  `orderby` tinyint(4) NOT NULL default '50' COMMENT '排序',
  `attr_input_type` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '属性输入类型',
  `attr_type` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '属性是否可选',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  KEY `cat_id` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='属性';
...
CREATE TABLE IF NOT EXISTS `svcart_product_type_attribute_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '属性名称',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商品类型多语言描述表';
...
CREATE TABLE IF NOT EXISTS `svcart_promotions` (
  ...
  `store_id` int(11) NOT NULL default '0' COMMENT '商店编号',
  `type` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '促销类型[0:减免;1:折扣;2:特惠品]',
  ...
  `user_rank` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '促销类型',
  `min_amount` decimal(10,2) unsigned NOT NULL default '0.00' COMMENT '最小金额',
  `max_amount` decimal(10,2) unsigned NOT NULL default '0.00' COMMENT '最大金额',
  `orderby` tinyint(4) NOT NULL default '50' COMMENT '排序',
  `status` char(1) collate utf8_unicode_ci NOT NULL default '1' COMMENT '0:无效;1:有效;2:删除',
  ...
  KEY `store_id` (`store_id`),
  KEY `type` (`type`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='促销详细表';
...
CREATE TABLE IF NOT EXISTS `svcart_promotion_i18ns` (
  ...
  KEY `locale` (`locale`),
  FULLTEXT KEY `title` (`title`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='促销详细多语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_promotion_products` (
  ...
  PRIMARY KEY  (`id`),
  KEY `store_id` (`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='促销商品表';
...
CREATE TABLE IF NOT EXISTS `svcart_providers` (
  ...
  `store_id` int(11) NOT NULL default '0' COMMENT '商店编号',
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '供应商名称',
  `description` text collate utf8_unicode_ci COMMENT '供应商描述',
  `meta_keywords` tinytext collate utf8_unicode_ci COMMENT 'SEO关键字',
  `meta_description` tinytext collate utf8_unicode_ci COMMENT 'SEO描述',
  `contact_name` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '联系人',
  `contact_email` varchar(200) collate utf8_unicode_ci NOT NULL default '',
  `contact_tele` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '联系电话',
  `contact_mobile` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '联系人手机',
  `contact_fax` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '联系传真',
  `contact_address` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '联系地址',
  `contact_zip` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '联系邮编',
  ...
  KEY `status` (`status`),
  KEY `store_id` (`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='供应商';
...
CREATE TABLE IF NOT EXISTS `svcart_provider_products` (
  ...
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='供应商商品';
...
CREATE TABLE IF NOT EXISTS `svcart_region_i18ns` (
  ...
  KEY `locale` (`locale`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='地区多语言';
...
CREATE TABLE IF NOT EXISTS `svcart_shipping_areas` (
  ...
  KEY `store_id` (`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='配送地区';
...
CREATE TABLE IF NOT EXISTS `svcart_shipping_area_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '配送区域名',
  `description` text collate utf8_unicode_ci COMMENT '配送区域描述',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='配送方式多语言';
...
CREATE TABLE IF NOT EXISTS `svcart_stores` (
  ...
  `contact_email` varchar(200) collate utf8_unicode_ci NOT NULL default '',
  `contact_tele` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `contact_mobile` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `contact_fax` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '传真',
  ...
  PRIMARY KEY  (`id`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='店铺表[多店铺版用]';
...
CREATE TABLE IF NOT EXISTS `svcart_store_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '店铺名称',
  `description` text collate utf8_unicode_ci COMMENT '店铺描述',
  `address` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '地址',
  `telephone` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '联系电话',
  `zipcode` varchar(10) collate utf8_unicode_ci NOT NULL default '' COMMENT '邮编',
  `transport` varchar(255) collate utf8_unicode_ci NOT NULL default '' COMMENT '交通',
  `map` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '地图',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='店铺多语言描述表[多店铺版用]';
...
CREATE TABLE IF NOT EXISTS `svcart_store_products` (
  ...
  KEY `store_id` (`store_id`),
  KEY `product_id` (`product_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='店铺商品[多店铺版用]';
...
CREATE TABLE IF NOT EXISTS `svcart_topic_i18ns` (
  ...
  `intro` text collate utf8_unicode_ci COMMENT '专题介绍',
  `meta_keywords` tinytext collate utf8_unicode_ci COMMENT 'SEO分类关键字',
  `meta_description` tinytext collate utf8_unicode_ci COMMENT 'SEO分类描述',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  ...
  KEY `locale` (`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='专题多语言表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='专题商品表';
...
CREATE TABLE IF NOT EXISTS `svcart_users` (
  ...
  `name` varchar(20) collate utf8_unicode_ci NOT NULL default '' COMMENT '昵称',
  `password` varchar(64) collate utf8_unicode_ci NOT NULL default '' COMMENT '登陆密码',
  `email` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '邮箱',
  `address_id` varchar(200) collate utf8_unicode_ci NOT NULL default '0' COMMENT '地址ID',
  `question` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '问题',
  `answer` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '密码',
  ...
  `verify_status` char(1) collate utf8_unicode_ci NOT NULL default '0' COMMENT '会员认证状态[0 未认证 1已认证 2 取消认证]',
  `unvalidate_note` varchar(60) character set utf8 NOT NULL default '' COMMENT '会员认证备注',
...
CREATE TABLE IF NOT EXISTS `svcart_user_accounts` (
  ...
  PRIMARY KEY  (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户账单';
...
CREATE TABLE IF NOT EXISTS `svcart_user_balance_logs` (
  ...
  PRIMARY KEY  (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户资金日志表';
...
CREATE TABLE IF NOT EXISTS `svcart_user_configs` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户参数';
...
CREATE TABLE IF NOT EXISTS `svcart_user_config_i18ns` (
  ...
  PRIMARY KEY  (`id`),
  KEY `locale` (`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户参数描述多语言';
...
CREATE TABLE IF NOT EXISTS `svcart_user_favorites` (
  ...
  `user_id` int(11) NOT NULL default '0' COMMENT '用户编号',
  `type` char(2) collate utf8_unicode_ci NOT NULL default '0' COMMENT '收藏类型[商品(p)，商品分类(pc)，文章分类(ac)，品牌(b)，文章(a)]',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户收藏';
...
CREATE TABLE IF NOT EXISTS `svcart_user_friends` (
  ...
  `contact_name` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `contact_mobile` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `contact_email` varchar(100) collate utf8_unicode_ci NOT NULL default '',
  `contact_user_name` varchar(60) collate utf8_unicode_ci NOT NULL default '',
  `birthday` date NOT NULL default '0000-00-00',
  `birthday_wishes` varchar(200) collate utf8_unicode_ci NOT NULL default '',
  `remark` tinytext collate utf8_unicode_ci,
  `last_time` datetime NOT NULL default '2008-01-01 00:00:00',
  `address` varchar(220) collate utf8_unicode_ci NOT NULL default '',
  `constellation` varchar(20) collate utf8_unicode_ci NOT NULL default '',
  `personality` varchar(50) collate utf8_unicode_ci NOT NULL default '',
  `sex` char(1) collate utf8_unicode_ci NOT NULL default '0',
  `contact_other_email` varchar(100) character set utf8 NOT NULL default '' COMMENT '好友备用邮箱',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  KEY `user_id` (`user_id`)
...
CREATE TABLE IF NOT EXISTS `svcart_user_friend_cats` (
  ...
  `cat_desc` varchar(200) collate utf8_unicode_ci NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `svcart_user_infos` (
  ...
  PRIMARY KEY  (`id`),
  KEY `type` (`type`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户项目表';
...
CREATE TABLE IF NOT EXISTS `svcart_user_info_i18ns` (
  ...
  `name` varchar(100) collate utf8_unicode_ci NOT NULL default '' COMMENT '名称',
  `values` text collate utf8_unicode_ci COMMENT '可选值',
  `message` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '提示信息',
  `remark` text collate utf8_unicode_ci COMMENT '备注',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  ...
  KEY `locale` (`locale`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户项目多语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_user_info_values` (
  ...
  `value` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '项目值',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
...
CREATE TABLE IF NOT EXISTS `svcart_user_point_logs` (
  ...
  PRIMARY KEY  (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户积分日志表';
...
CREATE TABLE IF NOT EXISTS `svcart_user_rank_i18ns` (
  ...
  `name` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '等级名称',
  `descrption` text collate utf8_unicode_ci COMMENT '等级描述',
  `img` varchar(200) collate utf8_unicode_ci NOT NULL default '' COMMENT '等级图片',
  `created` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '创建时间',
  `modified` datetime NOT NULL default '2008-01-01 00:00:00' COMMENT '修改时间',
  PRIMARY KEY  (`id`),
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户等级多语言表';
...
CREATE TABLE IF NOT EXISTS `svcart_virtual_cards` (
  ...
  `product_id` int(11) NOT NULL default '0' COMMENT '商品id',
  `card_sn` varchar(30) collate utf8_unicode_ci NOT NULL default '' COMMENT '虚拟卡卡号',
  `card_password` varchar(30) collate utf8_unicode_ci NOT NULL default '' COMMENT '虚拟卡密码',
