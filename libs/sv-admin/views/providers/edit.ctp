...
<p class="add_categories"><strong><?php echo $html->link($html->image('add.gif',array('align'=>'absmiddle'))."供应商列表","/".(empty($_SESSION['cart_back_url'])?$this->params['controller']:$_SESSION['cart_back_url']),'',false,false);?></strong></p>
<!--Main Start-->
...
<!--Providers_Config-->
	  <div class="shop_config menus_configs">
		...
		<dd><input type="text" style="width:200px;border:1px solid #649776;" id="provider_name" name="data[Provider][provider_sn]"value="<?php echo $provider_edit['Provider']['provider_sn'];?>"/> </dd></dl>
		...
		<dd><input type="text" style="width:355px;border:1px solid #649776;" id="Providermeta_keywords" name="data[Provider][meta_keywords]"value="<?php echo $provider_edit['Provider']['meta_keywords'];?>"/>
		...
		<dd>
			<input id="BrandStatus" name="data[Provider][status]" type="radio" class="inputcheckboxradio" value="1" <?php if($provider_edit['Provider']['status']){?>checked<?php }?> ><label>是</label>
			<input id="BrandStatus" name="data[Provider][status]" type="radio" class="inputcheckboxradio" value="0" <?php if($provider_edit['Provider']['status']==0){?>checked<?php }?> ><label>否</label></dd>
		</dl>
