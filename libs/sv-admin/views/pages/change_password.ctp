 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: change_password.ctp 781 2009-04-18 12:48:57Z huangbo $
*****************************************************************************/
?>	
		<div class="menber_login">
		<dl><dt>管理员姓名：</dt><dd><p class="confim_locale"><?=$operator['Operator']['name']?></p></dd></dl>
		...
		<input type="hidden" id="id" name="id" value="<?=$operator['Operator']['id']?>" />
