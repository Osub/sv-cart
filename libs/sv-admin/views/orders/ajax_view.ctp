 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: view.ctp 1163 2009-04-30 12:35:15Z zhengli $
*****************************************************************************/
?>
...
<!--Other Stat-->
	<div class="order_stat athe_infos tongxun">
	  ...
	  <div class="box">
		...
		<dl><dt>客户给商家留言：</dt><dd><textarea style="width:355px;height:60px;border:1px solid #649776;overflow-y:scroll" name="data[Order][note]" value="<?echo $order_info['Order']['note']?>"></textarea></dd></dl>
...
<? echo $form->end();?>
  ...
  <input type="hidden" name="product_id" id="product_id" />
	  ...
	  <p class="submit_btn"><span><input type="button" value="加入订单" onclick="insert_products()"/></span></p>
<? echo $form->end();?>		
	  </div>
	</div>
<!--Product Infos End-->
  ...
  <input type="hidden" name="act_type" value="money"></>
	<div class="order_stat properies expend_infos">
	  ...
	  <div class="properies_left">
		...
		<dl><dt>使用积分：</dt><dd><?echo sprintf("%01.2f",$order_info['Order']['point_fee'])?><input type="hidden" name="point" value="<?echo $order_info['Order']['point_fee']?>"></dd></dl>
	  ...
	  <div id="handle_detail">
		...
		<dd class="orders_submits">
		  ...
		  <?if(isset($order_action['ship']) && $order_action['ship']){?>
			<span><input type="button" value="发货" onclick="order_show_hide('ship_detail')"/></span>
		  <?}?>
...
<dd class="orders_submits"><input type="button" value="确定" name="ship" id="ship" onclick="orderaction(this)" /><input type="button" value="返回" onclick="come_to_back()"/></dd>
</dl>
</div>
<!--设为未付款详细框-->
...
<dl><dt style="padding-right:10px;"></dt>
	<dd class="orders_submits" style=""><span><input type="button" value="确定" name="unpay" id="unpay" onclick="orderaction(this)"/></span><span><input type="button" value="返回" onclick="come_to_back()"/></span></dd>
</dl>
</div>
...
<dl><dt style="padding-right:10px;"></dt>
<dd class="orders_submits"><span><input type="button" value="确定" name="cancel" id="cancel" onclick="orderaction(this)"/></span><span><input type="button" value="返回" onclick="come_to_back()"/></span></dd>
</dl>	
</div>
...
<dd class="orders_submits"><span><input type="button" value="确定" name="return" id="return" onclick="orderaction(this)"/></span><span><input type="button" value="返回" onclick="come_to_back()"/><span></dd>
</dl>
</div>
