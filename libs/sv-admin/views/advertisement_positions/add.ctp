...
<!--Mailtemplates_Config-->
	  <div class="shop_config menus_configs">
		...
		<dd><input type="text" style="width:357px;*width:180px;border:1px solid #649776" id="advertisement_name" name="data[AdvertisementPosition][name]" /> <font color="#ff0000">*</font></dd></dl>
		
		<dl><dt style="width:105px;">广告位宽度：</dt>
		<dd><input type="text" style="width:180px;*width:180px;border:1px solid #649776" id="advertisement_width" name="data[AdvertisementPosition][ad_width]" />&nbsp;像素<font color="#ff0000">*</font></dd></dl>
		<dl><dt style="width:105px;">广告位高度：</dt>
		<dd><input type="text" style="width:180px;*width:180px;border:1px solid #649776" id="advertisement_height" name="data[AdvertisementPosition][ad_height]" />&nbsp;像素<font color="#ff0000">*</font></dd></dl>
