...
<? if(@isset($languages) && sizeof($languages)>0){
		...
		<dd><input type="text" style="width:100px;*width:180px;border:1px solid #649776" name="data[FlashImage][orderby]" onkeyup="check_input_num(this)"  /><br /> 如果您不输入排序号，系统将默认为50</dd></dl>	
