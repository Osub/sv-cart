...
<p class="add_categories"><strong><?php echo $html->link($html->image('add.gif',array('align'=>'absmiddle'))."留言列表","/".(empty($_SESSION['cart_back_url'])?$this->params['controller']:$_SESSION['cart_back_url']),'',false,false);?></strong></p>

<!--Main Start-->
<!--CommentsConfig-->
<div class="home_main">
<?php echo $form->create('Message',array('action'=>'product_view/'.$usermessage['UserMessage']['id']));?>
