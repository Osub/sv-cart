...
<?php if(isset($languages) && sizeof($languages)>0){
	foreach ($languages as $k => $v){?>
		<p class="products_name" style="padding-left:55px;margin-bottom:5px;"><?php echo $html->image($v['Language']['img01'])?><span><input type="text" style="width:270px;" id="name<?php echo $v['Language']['locale']?>" name="data[NavigationI18n][<?php echo $k;?>][name]" <?php if(isset($this->data['NavigationI18n'][$v['Language']['locale']])){?>value="<?php echo  $this->data['NavigationI18n'][$v['Language']['locale']]['name'];?>"<?php }else{?>value=""<?php }?>/> <font color="#ff0000">*</font></span></p>
...
<?php if(isset($languages) && sizeof($languages)>0){
	...
	<input id="NavigationI18n<?php echo $k;?>Locale" name="data[NavigationI18n][<?php echo $k;?>][locale]" type="hidden" value="<?php echo  $v['Language']['locale'];?>">
	   <?php if(isset($this->data['NavigationI18n'][$v['Language']['locale']])){?>
	<input id="NavigationI18n<?php echo $k;?>Id" name="data[NavigationI18n][<?php echo $k;?>][id]" type="hidden" value="<?php echo  $this->data['NavigationI18n'][$v['Language']['locale']]['id'];?>">
	   <?php }?>
	   	<input id="NavigationI18n<?php echo $k;?>NavigationId" name="data[NavigationI18n][<?php echo $k;?>][navigation_id]" type="hidden" value="<?php echo  $this->data['Navigation']['id'];?>">
<?php 
	}
}?>
...
<?php if(isset($languages) && sizeof($languages)>0){
	foreach ($languages as $k => $v){?>
		<p class="products_name" style="padding-left:55px;margin-bottom:5px;"><?php echo $html->image($v['Language']['img01'])?><span><input type="text" style="width:270px;" name="data[NavigationI18n][<?php echo $k;?>][url]" value="<?php if(isset($this->data['NavigationI18n'][$v['Language']['locale']]))echo $this->data['NavigationI18n'][$v['Language']['locale']]['url'];?>" /></span></p>
<?php }
	}?>	
		<h2 style="width:80px;margin-bottom:5px;">描述：</h2>
<?php if(isset($languages) && sizeof($languages)>0){
	foreach ($languages as $k => $v){?>
		<p class="products_name" style="padding-left:55px;margin-bottom:5px;"><?php echo $html->image($v['Language']['img01'])?><span><textarea style="height:95px;width:340px;" name="data[NavigationI18n][<?php echo $k;?>][description]" ><?php if(isset($this->data['NavigationI18n'][$v['Language']['locale']]))echo $this->data['NavigationI18n'][$v['Language']['locale']]['description'];?></textarea></span></p>
<?php }
	}?>			
	  </div>
	</div>
