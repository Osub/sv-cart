 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: add.ctp 2952 2009-07-16 09:56:25Z huangbo $
*****************************************************************************/
?>
<!--Main Start-->
...
<?php }}}}}}?>
	...
	<?php }?>
		...
		<dl><dt>商品重量：</dt><dd><input type="text" class="text_inputs" value="" name="data[Product][weight]" id="ProductWeight"/>
			...
			<dl style="*padding:4px 0;"><dt style="padding-top:1px">默认库存：</dt><dd class="best_input"><input name="data[Product][quantity]" id="ProductQuantity" value="<?php echo $SVConfigs['default_stock']?>"/></dd></dl>
