...
<p class="add_categories"><strong><?php echo $html->link($html->image('add.gif',array('align'=>'absmiddle'))."服务商品列表","/".(empty($_SESSION['cart_back_url'])?$this->params['controller']:$_SESSION['cart_back_url']),'',false,false);?></strong></p>


<!--Main Start-->
<div class="home_main">
<?php  echo $form->create('product_services',array('action'=>'view/'.$product_id,'name'=>'thisForm','id'=>'thisForm','OnSubmit'=>'return download_product_check();'));?>
