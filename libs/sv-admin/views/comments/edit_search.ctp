 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: edit_search.ctp 946 2009-04-24 00:36:19Z huangbo $
*****************************************************************************/
?> 
<div class="content">
...
<?if( isset( $restore ) ){?>
	   <p class="user_comments"><strong>管理员 <?=$restore['Comment']['name']; ?></strong> 对 <strong><?=$comment['Comment']['name']; ?></strong> 回复</p>
	   <div class="comment_info">
	   <p class="time"><?=$restore['Comment']['created']; ?></p>
	   <br />
	   <p class="content_text"><?=$restore['Comment']['content']; ?></p>
	   <br />
	   <p class="grad">IP地址:<?=$restore['Comment']['ipaddr']; ?></p>
	   </div>
<?}?>
	  </div>
	</div>
...
<td valign="top" width="50%" style="padding-left:5px;">
	<div class="order_stat athe_infos writeback_coment">
	  ...
	  <p style="clear:both"></p>
		...
		<input type="hidden" name="data[Comment][parent_id]" value="<?=$comment['Comment']['id']; ?>">
