...
<div class="home_main">
	...
	<?php echo $form->create('Tag',array('action'=>'add' ,'method'=>'POST' , 'onsubmit'=>'return type_check();'));?>
<div class="order_stat athe_infos configvalues">
	  ...
	  <div class="shop_config menus_configs">
		...
		<dl>
			<dt><p><?php echo $html->image($v['Language']['img01'])?></p></dt>
			<dd>
			<input type="text" style="width:290px;border:1px solid #649776" id="tag_name_<?php echo $v['Language']['locale']?>" name="tag_name_<?php echo $v['Language']['locale']?>" value="" />
			</dd>
		</dl>
		<?php }}?>	
		<dl><dt>是否显示: </dt>
			<dd class="best_input">
			<input type="radio" name="status" value="1" checked />显示<input type="radio" name="status" value="0"  />不显示 
	    	</dd>
	    </dl>
		<dl><dt>搜索商品: </dt>
			<dd>
			<input type="text" style="width:190px;border:1px solid #649776" name="keywords" id="keywords" />&nbsp;<input type="button" name="search_product" onclick="javascript:tag_product();" value="搜索商品"/>
	    	</dd>
	    </dl>
	  	<dl><dt>搜索文章: </dt>
		...
		<dl><dt>可选商品: </dt><dd><select id="source_select1" name="source_select1"></dd></dl>
			</select>
			</div>
			<div id="article_select" style="display:none">
		<dl><dt>可选文章: </dt><dd>	<select id="source_select2" name="source_select2"></dd></dl>
			</select>
			</div>
		</div>		
	  </div>
...
<input id="select_type" type="hidden" name="select_type" value="0" />
<?php $form->end();?></div>
</div>
