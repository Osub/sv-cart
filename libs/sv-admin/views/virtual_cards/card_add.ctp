...
<div class="order_stat athe_infos configvalues">
	...
	<dd><input type="text" style="width:120px;*width:180px;border:1px solid #649776" name="data[VirtualCard][end_date]" id="date"  readonly="readonly" /></dd><button id="show" type="button"><?=$html->image('calendar.gif')?></button></dl>
