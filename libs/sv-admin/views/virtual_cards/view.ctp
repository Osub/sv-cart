...
<div class="home_main">
<ul class="tab">
	<li class="hover" id="tabs1" onmouseover="overtab('tabs',1,5)"><span>基本信息</span></li>
	<li class="normal" id="tabs2" onmouseover="overtab('tabs',2,5)"><span>详细</span></li>
	<li class="normal" id="tabs3" onmouseover="overtab('tabs',3,5)"><span>相册</span></li>
	<li class="normal" id="tabs4" onmouseover="overtab('tabs',4,5)"><span>属性</span></li>
	<li class="normal" id="tabs5" onmouseover="overtab('tabs',5,5)"><span>关联</span></li>
</ul>
<?php echo $form->create('virtual_cards',array('action'=>''.$this->data['Product']['id'],"OnSubmit"=>'return products_check();'));?>
...
<?php $product_type_list=$this->requestAction("/commons/product_type_list/".$this->data['Product']['product_type_id']."");?>
	...
	<div class="order_stat properies">
	  <div class="box">
<?php echo $form->create('',array('action'=>"view/".$this->data['Product']['id'],'name'=>"ProAttrForm","id"=>"ProAttrForm"));?>
