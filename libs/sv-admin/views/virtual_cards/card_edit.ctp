...
<div class="order_stat athe_infos configvalues">
	...
	<dd><input type="text" style="width:300px;*width:180px;border:1px solid #649776" name="data[VirtualCard][card_sn]" value="<?php echo $virtualcard_info['VirtualCard']['card_sn']?>" /></dd></dl>
	<dl><dt style="width:100px;">卡片密码： </dt>
	<dd><input type="text" style="width:300px;*width:180px;border:1px solid #649776" name="data[VirtualCard][card_password]" value="<?php echo $virtualcard_info['VirtualCard']['card_password']?>" /></dd></dl>
	<dl><dt style="width:100px;">截至使用日期： </dt>
	<dd><input type="text" style="width:120px;*width:180px;border:1px solid #649776" name="data[VirtualCard][end_date]" id="date" value="<?php echo date('Y-m-d',strtotime($virtualcard_info['VirtualCard']['end_date']))?>"  readonly="readonly" /></dd><?php echo $html->image("calendar.gif",array('width'=>'18','height'=>'18','alt'=>'Calendar',"id"=>"show","class"=>"calendar"))?></dl>
