 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: card.ctp 2703 2009-07-08 11:54:52Z huangbo $
*****************************************************************************/
?>
...
<div class="home_main" style="width:96%;padding:0 0 20px 0;min-width:970px;width:expression((documentElement.clientWidth < 970) ? '970px' : '96%' ); ">
	...
	<li class="number"><?php echo $v['VirtualCard']['id']?></li>
	<li class="username"><span><?php echo $v['VirtualCard']['card_sn']?></span></li>
	<li class="msg_headers"><span><?php echo $v['VirtualCard']['card_password']?></span></li>
	<li class="type"><?php echo $v['VirtualCard']['end_date']?></li>
	<li class="msg_time"><?php echo $v['VirtualCard']['order_id']?></li>
	<li class="writeback"><?php if($v['VirtualCard']['is_saled'] == 1){?><?php echo $html->image('yes.gif')?><?php }else{?><?php echo $html->image('no.gif')?><?php }?></li>
	<li class="hadle">
