...
<p class="add_categories"><strong><?php echo $html->link($html->image('add.gif',array('align'=>'absmiddle'))."部门列表","/".(empty($_SESSION['cart_back_url'])?$this->params['controller']:$_SESSION['cart_back_url']),'',false,false);?></strong></p>
...
<!--Communication Stat-->
	<div class="order_stat athe_infos department_config">
	  ...
	  <br />
		...
		<dd>
		<input type="text" style="width:150px;border:1px solid #649776" id="name<?php echo $v['Language']['locale']?>" name="data[DepartmentI18n][<?php echo $k?>][name]"  /> <font color="#F94671">*</font>
		</dd>
		</dl>
		<?php 
		}
