 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: option_add.ctp 4218 2009-09-11 02:34:41Z huangbo $
*****************************************************************************/
?>
<!--时间控件层start-->
...
<!--end-->
<?php echo $form->create('votes',array('action'=>'/option_add/'.$vote_id));?>
<div class="content">
...
<?php if(isset($languages) && sizeof($languages)>0){
	...
	<dd><input type="text" style="width:300px;border:1px solid #649776" name="data[VoteOptionI18n][<?php echo $k?>][name]" /></dd></dl>
...
<?php if(isset($languages) && sizeof($languages)>0){
	foreach ($languages as $k => $v){?>
	<dl><dt style="width:100px;"><?php echo $html->image($v['Language']['img01'])?></dt>
	<dd><textarea style="width:300px;border:1px solid #649776" name="data[VoteOptionI18n][<?php echo $k?>][description]" ></textarea></dd></dl>

<?php }}?>
	<dl><dt style="width:100px;">是否有效： </dt>
	<dd><input type="radio"  name="data[VoteOption][status]" value="1" checked   />是<input type="radio" name="data[VoteOption][status]" value="0"  />否</dd></dl>
