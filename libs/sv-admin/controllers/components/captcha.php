...
class CaptchaComponent extends Object {
    ...
    //size configuration
    var $_image_height = 20; //the height of the captcha image
    var $_image_width = 70; //the width of the captcha image
    ...
    var $_line_distance = 10; //how far apart to space the lines from eachother in pixels
    var $_line_thickness = 1; //how thick to draw the lines in pixels
    var $_arc_linethrough =false;
    ...
    var $_code_length = 4; //the length of the code to generate
    var $_font_size = 12; //the font size
    var $_gd_font_size = 12; //the approxiate size of the font in pixels
    ...
    var $_text_transparency_percentage = 20; //the percentage of transparency, 0 to 100
    var $_text_angle_maximum = 10; //maximum angle of text in degrees
    var $_text_angle_minimum = -10; //minimum angle of text in degrees
    var $_text_maximum_distance = 14; //maximum distance for spacing between letters in pixels
    var $_text_minimum_distance = 18; //minimum distance for spacing between letters in pixels
    var $_text_x_start = 2; //the x-position on the image where letter drawing will begin
    
    
    //filename and/or directory configuration
    var $_audio_path = 'audio/'; //the full path to wav files used
    var $_gd_font_file = 'gdfonts/caveman.gdf'; //the gd font to use
