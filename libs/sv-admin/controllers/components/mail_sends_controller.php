		...
		foreach( $mail_send_queue_info as $k=>$v){
			...
			$this->Email->fromName = $v['MailSendQueue']['sender_name'];//网店名称
		 	...
		 	eval("\$subject = \"$subject\";");
		  	...
		  	$to_name = $v['MailSendQueue']['receiver_name'];//收件人姓名
		  	$to_email = $v['MailSendQueue']['receiver_email'];//收件人email
		  	$addcc_to_name = $v['MailSendQueue']['cc_name'];//抄送人姓名
		  	$addcc_to_email = $v['MailSendQueue']['cc_email'];//抄送人email
		  	$addbcc_to_name = $v['MailSendQueue']['bcc_name'];//抄送人姓名
		  	$addbcc_to_email = $v['MailSendQueue']['bcc_email'];//抄送人email
