 ...
 */
class SV_Dispatcher extends Object {
/**
 * Base URL
 *
 * @var string
 ...
 */
	function cached($url) {
		...
		if (Configure::read('Cache.check') === true) {
			...
			$path = strtolower(implode(array($_SERVER['SERVER_NAME'],$path,$CookieComponent->read('locale'),$CookieComponent->read('template'),$CookieComponent->read('template_style')),"_"));
