 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: setting_ui.ctp 1273 2009-05-08 16:49:08Z huangbo $
*****************************************************************************/
?>
<?php echo $form->create('pages',array('action'=>'/setup/','id'=>"js_setting",'method'=>'post',"onsubmit"=>"return check_form();"));?>
<div class="content">
<br />
<!--Setting-->
<div class="home_main">
...
function pre_step(){
	...
	setting_form.action = webroot_dir +"pages/check";
	setting_form.submit();
}
function check_form(){
