 ...
 * ===========================================================================
 * $开发: 上海实玮$
 * $Id: flash.ctp 1215 2009-05-06 05:46:48Z huangbo $
*****************************************************************************/
?>
...
<div class="home_main">
	...
	<?php if(isset($host)){?><br /><br /><p class="handdle ok"><span class="float_l add_favorite"><a href="javascript:fav('<?=$host?>','SV-Cart 首页')">收藏  《SV-Cart 首页》</a> | <a href="javascript:fav('<?=$host?>/sv-admin','SV-Cart 后台管理中心')">收藏 《SV-Cart 后台管理中心》</a></span></p><?php }?>
